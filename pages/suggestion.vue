      ...
      <div class="container">
        <div class="row g-5">
          ...
          <div class="offset-xl-2 col-lg-6">
            <div class="contact-form custom-form-style-2 form-style-2">
              <div class="section-title">
                <h4 class="title">Envoyez une suggestion</h4>
              </div>
              <form class="rnt-contact-form rwt-dynamic-form" ref="form" @submit.prevent="sendEmail">
                <div class="row row--10">
                  ...
                  <div class="form-group col-12">
                    <textarea name="message" cols="30" rows="6" placeholder="Votre message *" v-model="message"></textarea>
                    <div v-if="$v.message.$error"><p class="custom-validation-error-msg">Le message est obligatoire.</p></div>
                  </div>
                  <div class="form-group col-12 text-left mt-5">
                    <recaptcha />
