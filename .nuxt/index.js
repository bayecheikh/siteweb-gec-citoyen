...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"GEC CITOYEN","titleTemplate":"%s","htmlAttrs":{"lang":"zxx"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"script":[{"src":"\u002Fjs\u002Fpace.min.js"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Fimages\u002Ffavicon.png"}],"style":[]},
  ...
  if (typeof nuxt_plugin_axios_f15fec52 === 'function') {
    await nuxt_plugin_axios_f15fec52(app.context, inject)
  }
