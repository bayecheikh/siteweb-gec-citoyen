            ...
            <div class="container">
                <div class=" row g-5">
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6">
                        <div class="edu-counterup counterup-style-6">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="53.969" height="41.098"
                                    viewBox="0 0 83.969 51.098">
                                    <g id="Groupe_7607" data-name="Groupe 7607" transform="translate(-739.016 -915.625)">
                                        ...
                                        <ellipse id="Ellipse_861" data-name="Ellipse 861" cx="13" cy="13.5" rx="13"
                                            ry="13.5" transform="translate(783 919)" fill="#0a3764" />
                                        <g id="Groupe_7605" data-name="Groupe 7605" transform="translate(788 927)">
                                            <path id="Tracé_7173" data-name="Tracé 7173" d="M20,6,9,17,4,12"
                                                transform="translate(-4 -6)" fill="none" stroke="#fff"
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6">
                        <div class="edu-counterup counterup-style-6">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36.793" height="36.763"
                                    viewBox="0 0 56.793 56.763">
                                    ...
                                    <g id="Groupe_7609" data-name="Groupe 7609" transform="translate(0.5 0.541)">
                                        ...
                                        <path id="Tracé_8087" data-name="Tracé 8087"
                                            ...
                                            transform="translate(-127.25 -45.028)" fill="#fff" stroke="#fff"
                                            stroke-width="1" />
                    ...
                    <div class="col-12 col-lg-3 col-md-6 col-sm-6">
                        <div class="edu-counterup counterup-style-6 border-none">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="43.97" height="42.865"
                                    viewBox="0 0 53.97 42.865">
