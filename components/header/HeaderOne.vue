                            ...
                            <ul class="header-action">
                                <div class="banner-btn custom-banner-btn">
                                    <li class="custom-header-btn">
                                        <a  class="edu-btn custom-edu-btn custom-btn-sign-in text-uppercase"  @click="onClickSeConnecter()">
                                            Se connecter 
                                        </a>
                                    </li>
                                    <li class="custom-header-btn">
                                        <n-link to="" class="edu-btn custom-btn-sign-up btn-orange text-uppercase">
                                            Créer un compte
                                        </n-link>
                                    </li>
                                </div>
                        ...
                        <div v-if="isLoggedIn"> 
                           <div class=" custom-loggout">
                            <div class="custom-loggout-btn">
                                        <a class="edu-btn custom-btn-sign-out text-uppercase" @click="onClickSeDeconnecter()">
                                            <span v-if="!isDeconnecting" >Se déconnecter</span><span v-if="isDeconnecting" ><svg width="24" height="24" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
...
<div v-if="isPopUpChooseConnexionMode" class="login-form-box border-grey custom-template offset-xl-2 col-lg-6">
    <div class="contact-form ">
        ...
        <div class="section-title">
            ...
            <p class="custom-information-msg">Vous pouvez vous connecter à la plateforme GEC CITOYEN à l'aide de votre Numéro Personnel d'Identification sur PNS ou avec vos identifiants XROAD BJ.</p>
        </div>
        <div class = "custom-mode-connexion-btn-group">
            <div>
                <button class ="edu-btn custom-mode-connexion-btn" @click="onClickChooseNPS()">Continuer avec PNS</button>
            </div>
            <div>
                <button @click="onClickChooseXroad()" class="edu-btn custom-mode-connexion-btn">Continuer avec XROAD</button>
            </div>
        </div>
    </div>
    ...
    <div v-if="isPopUpConnexionNPSVisible" class="login-form-box border-grey custom-template offset-xl-2 col-lg-6">
        ...
        <form ref="pnsform" >
            ...
            <div class="form-group">
                <button @click="submitPNSConnexion" type="button" class="edu-btn custom-nps-sign-in-btn btn-medium"><span v-if="!isPNSConnecting" >Se connecter</span><span v-if="isPNSConnecting" ><svg width="24" height="24" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
  <g fill="none" fill-rule="evenodd">
    <g transform="translate(1 1)" stroke-width="2">
      <circle stroke-opacity=".5" cx="18" cy="18" r="18"/>
      <path d="M36 18c0-9.94-8.06-18-18-18">
...
<div v-if="isPopUpConnexionXroadVisible" class="login-form-box border-grey custom-template offset-xl-2 col-lg-6">
        <div class="contact-form ">
        ...
        <form ref="xroadform">
            <div class="form-group">
                ...
                <input v-model="model.xroad_email" type="email" autocomplete="off" name="xroad-email" id="xroad-email" placeholder="Email">
            </div>
            <div class="form-group">
                <label for="xroad-password">Mot de passe *</label>
                <input v-model="model.xroad_password" type="password" autocomplete="off" name="xroad-password" id="xroad-password" placeholder="Mot de passe">
                <span class="xroad-password-toggle" @click="toggleXroadPasswordVisibility"><i class="icon-76"></i></span>
            </div>
            <div v-if="!validXroadCredentials" >
            <p class="custom-error-msg">Email ou mot de passe incorrect.</p>
        </div>
            <div class="form-group">
                <button @click="submitXroadConnexion" type="button" class="edu-btn custom-nps-sign-in-btn btn-medium"><span v-if="!isXroadConnecting" >Se connecter</span><span v-if="isXroadConnecting" ><svg width="24" height="24" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
  <g fill="none" fill-rule="evenodd">
    <g transform="translate(1 1)" stroke-width="2">
      <circle stroke-opacity=".5" cx="18" cy="18" r="18"/>
      <path d="M36 18c0-9.94-8.06-18-18-18">
