        ...
        <div v-if="isPopUpChooseConnexionMode"
            ...
            <div class="left-block ">
                <div class="section-title ">
                    ...
                    <p class="custom-message">Pour déposer un courrier, connectez-vous avec votre compte PNS ou XROAD BJ.</p>
                </div>
            </div>
            <div class="right-block">
                ...
                <div class="connexion-mode">
                    ...
                    <div class="edu-form-check">
                        <input type="radio" value="xroad" id="xroad" name="connexionMode" @click="onRadioClickXROAD($event)">
