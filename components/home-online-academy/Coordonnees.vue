    ...
    <div class="login-form-box registration-form">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" name="reg-name" id="reg-name" placeholder="Votre nom">
            </div>
            <div class="form-group">
                <label for="reg-name">Prénom*</label>
                <input type="text" name="reg-name" id="reg-name" placeholder="Votre prénom">
            </div>
            <div class="form-group">
                <label for="log-email">Email*</label>
                <input type="email" name="log-email" id="log-email" placeholder="Votre Email">
            </div>
            <div class="form-group">
                <label for="reg-name">Adresse*</label>
                <input type="text" name="reg-name" id="reg-name" placeholder="Votre adresse">
            </div>
            <div class="form-group">
                <label for="reg-name">Téléphone*</label>
                <input type="text" name="reg-name" id="reg-name" placeholder="Votre numéro de téléphone">
            </div>
            ...
            <div class="form-group">
                <button type="button" class="edu-btn btn-medium">Suivant <i class="icon-4"></i></button>
            </div>
        </form>
    </div>
</template>
