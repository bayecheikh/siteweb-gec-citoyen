    ...
    <div class="login-form-box border-grey">
        ...
        <form>
            <div class="form-group">
                ...
                <input v-model="model.numero_ipn" type="email" name="current-log-email" id="current-log-email"
                    placeholder="Numéro IPN">
            </div>
            <div class="form-group">
                <label for="current-log-password">Mot de passe*</label>
                <input v-model="model.password" type="password" name="current-log-password" id="current-log-password"
            ...
            <div class="form-group">
                <button @click="submitConnexion" type="button" class="edu-btn btn-medium">Suivant <i
