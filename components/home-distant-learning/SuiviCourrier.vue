                ...
                <form class="rnt-contact-form rwt-dynamic-form" ref="form" @submit.prevent="isCodeValid()">
                    <div class="row row--10">
                        ...
                        <div class="d-flex align-items-center search-box">
                            ...
                            <button class="submit-button" name="submit" type="submit"> <span v-if="!isLoading"> <i class="icon-4"></i></span><span v-if="isLoading" ><svg width="24" height="24" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
